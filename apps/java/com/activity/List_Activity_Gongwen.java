 ...
 * 公文表
 */
public class List_Activity_Gongwen extends Activity implements OnClickListener {
private int Page = 1;
private int Count = 1;
private int Num = 1;
...
private List<Gongwen> mDataList = new ArrayList<>();
HashMap<Integer, Boolean> isOpenMap = new HashMap<>();
protected void onCreate(Bundle savedInstanceState) {
super.onCreate(savedInstanceState);
requestWindowFeature(Window.FEATURE_NO_TITLE);
setContentView(R.layout.list_activity_gongwen);
initView();
setDataFromNet("",1);
}
...
Type type = new TypeToken<ArrayList<Gongwen>>() {
}.getType();
...
R.layout.item_list_activity_gongwen, null);
...
holder.gwshr = (TextView) convertView.findViewById(R.id.gwshr);
holder.gwbt = (TextView) convertView.findViewById(R.id.gwbt);
holder.gwfj = (TextView) convertView.findViewById(R.id.gwfj);
convertView.setTag(holder);
} else {
holder = (ViewHolder) convertView.getTag();
}
final Gongwen bean=mDataList.get(position);
holder.gwshr.setText("公文审核人:"+bean.gwshr);
holder.gwbt.setText("公文标题:"+bean.gwbt);
holder.gwfj.setText("公文审批人姓名字符串:"+bean.gwfj);
