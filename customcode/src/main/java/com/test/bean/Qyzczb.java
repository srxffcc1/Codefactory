...
@ChineseName("政府抽查隐患;Detail;List=userName,jcry:FUNCTION=查看,记录;")
public class Qyzczb extends BasePojo {
...
//    @ChineseName("新添加字段  何悦 2015-07-24")
    ...
    public String fid;
//    @ChineseName("2019年1月16日09:43:33 添加人：严佳强")

    @ChineseName("检查人数")
    public String jcrs;
    @ChineseName("反馈日期")
    public String fkrq;
    @ChineseName("标志一次检查对应的多条记录")
    public String otm;
    @ChineseName(" 检查时间起")
    ...
    @ChineseName("是否上报;Spinner:string=未上报,已上报:code=2,3;YN  隐患类型:0 2代表未上报  1 3代表已上报")
    public String sfsb;
    @ChineseName("审核部门名称")
    ...
    public String qyid;
    @ChineseName("部门抽查是否发现隐患(Y/N);Spinner:string=是,否:code=Y,N;")
