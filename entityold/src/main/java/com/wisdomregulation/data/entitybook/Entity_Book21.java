...
public class Entity_Book21 extends Base_Entity {
private  List<String> fieldnamelsitchinese=new ArrayList<String>();
private  Map<String,String> fieldvaluemap=new HashMap<String, String>();
public Entity_Book21(){
	super.initsuper(fieldnamelsitchinese, fieldvaluemap);
}
{
	fieldnamelsitchinese.clear();
	fieldnamelsitchinese.add("安监管处呈");//0//0
	...
	fieldnamelsitchinese.add("违法事实及处罚依据");//17//17
	fieldnamelsitchinese.add("当事人的申辩意见");//18//18
	fieldnamelsitchinese.add("承办人意见");//19//19
	fieldnamelsitchinese.add("承办人1签名");//20//20
	fieldnamelsitchinese.add("承办人2签名");//21//21
	fieldnamelsitchinese.add("承办人签名日期");//22//22
	fieldnamelsitchinese.add("审核意见");//23//23
	fieldnamelsitchinese.add("审核人签名");//24//24
	fieldnamelsitchinese.add("审核人签名日期");//25//25
	fieldnamelsitchinese.add("审批意见");//26//26
	fieldnamelsitchinese.add("审批人签名");//27//27
	fieldnamelsitchinese.add("审批人签名日期");//28//28
