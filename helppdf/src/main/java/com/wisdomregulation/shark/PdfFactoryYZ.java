 ...
 */
public class PdfFactoryYZ extends PdfFactory {
    protected final static PdfFactoryYZ pdfhelp = (PdfFactoryYZ) new PdfFactoryYZ().setPostmark("扬州市安全生产监督管理局（公章）");

    public static PdfFactoryYZ create() {
        return pdfhelp;
    }
...
//            paragraph11.add(phrase12);
     ...
     * @param book
     */
    protected void printerFrameWorkG1_1(Base_Entity book) {
        try {
            ...
            phrase12_1.add(ChunkFactory.tablenounderLine("本文书一式两份：一份由安全生产监督管理部门备案，一份交被检查单位", -1,
                    simfang2312_z5));
            Phrase phrase12 = new Phrase();
            phrase12.add(ChunkFactory.tablenounderLine("", 298,
                    simfang2312_z5));
    ...
    protected void printerEntity_Book_2017_2(final Base_Entity book, final Object postmaskimage) {
        printerFrameWork(book, postmaskimage, new IPdfBackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                phrase1.add(ChunkFactoryNoCenter.underLine(book.push(), 351.75f, simfang2312_z5));
                ...
                String[] array = StringFactoryBuild.build().stringFormatIdentifyLnAndKeepLn(book.push(), 2788f, simfang2312_z5, 7 * simfang2312_z5.getSize(), -1, 0);
                phrase7.add(new Chunk("检查情况：", simfang2312_z5));
                phrase7.add(ChunkFactory.underLine(array[0], 2788f, simfang2312_z5, 7 * simfang2312_z5.getSize(), -1));
    ...
    protected void printerEntity_Book_2017_3(final Base_Entity book, final Object postmaskimage) {
        printerFrameWork(book, postmaskimage, new IPdfBackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                Phrase phrase1 = new Phrase();
                phrase1.add(ChunkFactoryNoCenter.underLine(book.push(), 231.25f, simfang2312_z5));
...
//                String[] array1=book.getValue("发现隐患").split("\n");
//                String[] array2=book.getValue("处理决定").split("\n");
...
//
//                    }else{
//                        faxianyinhuan2=book.getValue("发现隐患").replace(faxianyinhuan+"\n","");
//                        chulijueding2=book.getValue("处理决定").replace(chulijueding+"\n","");
//                    }
//
//                }
...
//                    extra.put("处理依据",chuliyiju2);
    ...
    protected void printerEntity_Book_2017_4Continue(final Base_Entity book, final Object postmaskimage) {
        printerFrameWork(book, postmaskimage, new IPdfBackFrame() {
            @Override
            public void writeContent() throws Exception {
                //此处写页面布局
                ...
                book.push();
                book.push();
                printerFrameWorkTitleNOCode(book, "安全生产行政执法文书", "责令限期整改指令书", "安监责改");
                Paragraph paragraph1 = new ParagraphBuilder();
                paragraph1.setLeading(simfang2312_z5.getSize() * 2f);
                paragraph1.setFirstLineIndent(simfang2312_z5.getSize() * 2f);
                Phrase phrase1 = new Phrase();
...
//                document.add(paragraph2);
                ...
                phrase3.add(new Chunk("", simfang2312_z5));
                book.push();
                String[] array = StringFactoryBuild.build().stringFormatIdentifyLnAndKeepLn(book.getValue("存在问题"), 9400f, simfang2312_z5, 0, -1, 0);
                String findQuestion1 = array[0];
                String findQuestion2 = array[1];
                phrase3.add(ChunkFactory.underLine(findQuestion1, 9400f, simfang2312_z5, 0, -1));
                paragraph3.add(phrase3);
                document.add(paragraph3);
//                Paragraph paragraph3 = new ParagraphBuilder();
//                paragraph3.setLeading(simfang2312_z5.getSize() * 2f);
...
//                    book.put("续页", str);
                    ...
                    printerEntity_Book_2017_4Continue(extra, postmaskimage);
                }
    ...
    protected void printerEntity_Book_2017_4(final Base_Entity book, final Object postmaskimage) {
        printerFrameWork(book, postmaskimage, new IPdfBackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                paragraph1.setFirstLineIndent(simfang2312_z5.getSize() * 2f);
                Phrase phrase1 = new Phrase();
                phrase1.add(ChunkFactoryNoCenter.underLine(book.push(), 173.25f, simfang2312_z5));
                phrase1.add(new Chunk("：", simfang2312_z5));
                paragraph1.add(phrase1);
                document.add(paragraph1);
                Paragraph paragraph2 = new ParagraphBuilder();
                ...
                phrase3.add(new Chunk("", simfang2312_z5));
                book.push();
                String[] array = StringFactoryBuild.build().stringFormatIdentifyLnAndKeepLn(book.getValue("存在问题"), 3260f, simfang2312_z5, 0, -1, 0);
                String findQuestion1 = array[0];
                String findQuestion2 = array[1];
                phrase3.add(ChunkFactory.underLine(findQuestion1, 3260f, simfang2312_z5, 0, -1));
                paragraph3.add(phrase3);
                document.add(paragraph3);
//                Paragraph paragraph3 = new ParagraphBuilder();
//                paragraph3.setLeading(simfang2312_z5.getSize() * 2f);
    ...
    protected void printerEntity_Book_2017_5(final Base_Entity book, final Object postmaskimage) {
        printerFrameWork(book, postmaskimage, new IPdfBackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                paragraph1.setFirstLineIndent(simfang2312_z5.getSize() * 2f);
                Phrase phrase1 = new Phrase();
                phrase1.add(ChunkFactoryNoCenter.underLine(book.push(), 152.25f, simfang2312_z5));
                phrase1.add(new Chunk("：", simfang2312_z5));
                paragraph1.add(phrase1);
                document.add(paragraph1);
                Paragraph paragraph2 = new ParagraphBuilder();
                ...
                phrase2.add(new Chunk("〕(", simfang2312_z5));
                phrase2.add(ChunkFactory.nounderLine(book.push(), "1234", simfang2312_z5));
                phrase2.add(new Chunk(")号],经对你单位整改情况进行复查，提出如下意见：\n", simfang2312_z5));
                paragraph2.add(phrase2);
                document.add(paragraph2);
                book.push();
                Paragraph paragraph2_2 = new ParagraphBuilder();
                paragraph2_2.setLeading(simfang2312_z5.getSize() * 1.9f);
//                paragraph2_2.setFirstLineIndent(simfang2312_z5.getSize() * 2f);
                Phrase phrase2_2 = new Phrase();
                String[] array = StringFactoryBuild.build().stringFormatIdentifyLnAndKeepLn(book.getValue("复查意见"), 4890f, simfang2312_z5, 0, -1, 0);
                String suggestion1 = array[0];
                String suggestion2 = array[1];
                phrase2_2.add(ChunkFactory.underLine(suggestion1, 4890f, simfang2312_z5));
                phrase2_2.add(new Chunk("。", simfang2312_z5));
                paragraph2_2.add(phrase2_2);
...
//                paragraph12.setFirstLineIndent(simfang2312_z5.getSize() * 2f);
                ...
                if (!"".equals(suggestion2)) {
                    ...
                    printerEntity_Book_2017_5Continue(extra, postmaskimage);
                }
            }
        });
    ...
    protected void printerEntity_Book_2017_5Continue(final Base_Entity book, final Object postmaskimage) {
        printerFrameWork(book, postmaskimage, new IPdfBackFrame() {
            @Override
            public void writeContent() throws Exception {
                //此处写页面布局
                ...
                document.add(space2);
                document.add(space2);
                printerFrameWorkTitleNOCode(book, "安全生产行政执法文书", "整改复查意见书", "安监复查");
                Paragraph paragraph1 = new ParagraphBuilder();
                paragraph1.setLeading(simfang2312_z5.getSize() * 2.5f);
                paragraph1.setFirstLineIndent(simfang2312_z5.getSize() * 2f);
                Phrase phrase1 = new Phrase();
...
//                paragraph2_2.setFirstLineIndent(simfang2312_z5.getSize() * 2f);
                Phrase phrase2_2 = new Phrase();
                String[] array = StringFactoryBuild.build().stringFormatIdentifyLnAndKeepLn(book.getValue("复查意见"), 6890f, simfang2312_z5, 0, -1, 0);
                String suggestion1 = array[0];
                String suggestion2 = array[1];
                phrase2_2.add(ChunkFactory.underLine(suggestion1, 6890f, simfang2312_z5));
                phrase2_2.add(new Chunk("。", simfang2312_z5));
                paragraph2_2.add(phrase2_2);
                document.add(paragraph2_2);
                Paragraph paragraph9 = new ParagraphBuilder();
...
//                paragraph9.setFirstLineIndent(simfang2312_z5.getSize()*2f);
                ...
                RadioCheckField bt10 = new RadioCheckField(dpfwPdfWriter,
                        ChunkFactory.setCheckBoxArea(105, 368, 10), "Yes0db298f77760414bb6d386f989b105ac",
                ...
                RadioCheckField bt11 = new RadioCheckField(dpfwPdfWriter,
                        ChunkFactory.setCheckBoxArea(105, 348, 10), "Yesf440958418a14abb8e0a74e500d463ce",
